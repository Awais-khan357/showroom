...
if (isset($_POST['login'])) {
    ...
    if (empty($email_signin) || empty($password_signin)) {
        ...
        if (mysqli_num_rows($query) <= 0) {
            ...
            if (password_verify($password_signin, $pass_word)) {
                $_SESSION['id'] = $id;
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">مرحبا بكم في سنيت! 👋</h4>
                        <p class="mb-4">يرجى تسجيل الدخول إلى حسابك وبدء المغامرة</p>

                        <form id="formAuthentication" class="mb-3" action="login.php" method="POST">
                            <div class="mb-3">
                                <label for="email" class="form-label">Email/بريد إلكتروني</label>
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Enter your email or username" autofocus />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                <div class="d-flex justify-content-between">
                                    <label class="form-label" for="password">Password/كلمة المرور</label>
                                </div>
                            ...
                            <div class="mb-3">
                                <label for="durationSelect" class="form-label">Language/لغة</label>
