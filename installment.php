...
if (isset($_POST['submit'])) {
    ...
    if($installment_no == 0){
        $installment_no = $_POST['ins'];
    }
    
    if (empty($pay)) {
    echo "<div class='alert alert-danger'>Payment method is required.</div>";
    exit;
}
    ...
    $stmt->bind_param("dssii", $paid_amount, $pay, $payment_date, $invoice_id, $installment_no);
...
<body>
                            ...
                            <div class="col-md-10 col-xl-10">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Add Installment </h5>
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <label class="form-label" for="customerName">Invoice Id/معرف الفاتورة</label>
            <div class="input-group input-group-merge">
                <span id="customerNameIcon" class="input-group-text"><i class="bx bx-user"></i></span>
                <input type="text" class="form-control" id="customerName" name="inid" value="<?php echo $row['invoice_id']; ?>" placeholder="Invoice Id" required />
            </div>
        </div>
        <div class="col-md-4">
            <label class="form-label" for="customerName">Customer Name/اسم العميل</label>
            <div class="input-group input-group-merge">
                <span id="customerNameIcon" class="input-group-text"><i class="bx bx-user"></i></span>
        ...
        <div class="col-md-4">
            <label class="form-label" for="customerId">Customer ID/معرف العميل</label>
            <div class="input-group input-group-merge">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <label class="form-label" for="customerAddress">Customer Address/عنوان العميل</label>
            <div class="input-group input-group-merge">
        ...
        <div class="col-md-6">
            <label class="form-label" for="carName">Car Name/اسم السيارة</label>
            <div class="input-group input-group-merge">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <label class="form-label" for="model">Model/نموذج</label>
            <div class="input-group input-group-merge">
        ...
        <div class="col-md-6">
            <label class="form-label" for="hssNumber">chassis number/رقم الشاصي</label>
            <div class="input-group input-group-merge">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <label class="form-label" for="installmentAmount">Installment Amount/مبلغ القسط</label>
            <div class="input-group input-group-merge">
        ...
        <div class="col-md-6">
            <label class="form-label" for="paidAmount">Paid Amount/المبلغ المدفوع</label>
            <div class="input-group input-group-merge">
    ...
    <div class="mb-3">
        <label for="durationSelect" class="form-label">Installment No/رقم القسط</label>
...
<div class="col-md-4 mt-4">
            <label class="form-label" for="customerId">Installment No/رقم القسط</label>
            <div class="input-group input-group-merge">
                <span id="customerIdIcon" class="input-group-text"><i class="bx bx-id-card"></i></span>
                <input type="text" class="form-control" id="customerId" name="ins"  placeholder="Installment no" />
            </div>
        </div>
        </div>


    <button type="submit" name="submit" class="btn btn-primary">Paid/مدفوع</button>
</form>
                                    </div>
                                </div>
                            </div>
