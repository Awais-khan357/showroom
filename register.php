...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($insert_stmt) {
                $insert_stmt->bind_param("sss", $_name, $_email, $password_hash);
        ...
        echo "Error preparing the select statement.";
    }
}
?>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">المغامرة تبدأ هنا 🚀</h4>
                        <p class="mb-4">اجعل إدارة تطبيقك سهلة وممتعة!</p>

                        <form id="formAuthentication" class="mb-3" action="register.php" method="POST">
                            <div class="mb-3">
                                <label for="username" class="form-label">Username/اسم المستخدم
                                </label>
                                <input type="text" class="form-control" id="username" name="uname"
                                    placeholder="Enter your username" autofocus />
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email/بريد إلكتروني
                                </label>
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Enter your email" />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label" for="password">Password/كلمة المرور
                                </label>
